...
\indent The enthalpy of vaporization is greater in magnitude than the enthalpy of fursion because more energy is necessary to \textit{break} the intermolecular forces (i.e. for liquid $\rightarrow$ gas) than is necessary to weaken the intermolecular forces (i.e. for solid $\rightarrow$ liquid). \hilight{TODO} %TODO
